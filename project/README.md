...
- **Краткое описание (2-4 предложения):**  
  `<Проект направлен на создание системы персонализированных рекомендаций художественной и научно-популярной литературы с учётом интересов пользователя, истории чтения и схожести профилей других читателей. Используются открытые датасеты, методы коллаборативной фильтрации и гибридные модели, сочетающие контентный и поведенческий подходы. Результатом станет REST API, возвращающее топ-N рекомендаций по идентификатору пользователя или его профилю.>`
